...
1. As we currently do not distribute binaries for the NX plugin, please follow the building instructions shown in the [README](https://github.com/facebookresearch/project_superdex/blob/v1.0.0/superdex_studio/superdex_cad_exporter/README.md).
