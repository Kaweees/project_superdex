...
<SiteImage src="img/examples/custom_components.webp" alt="SuperDex Physics debugger showing the example 2-DOF robot arm from the custom components example" />
