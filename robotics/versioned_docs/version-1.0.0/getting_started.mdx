...
[quick-start instructions (Python)](https://github.com/facebookresearch/project_superdex/blob/v1.0.0/README.md#quick-start-python) or [build it from source (C++, Python)](https://github.com/facebookresearch/project_superdex/blob/v1.0.0/README.md#building-from-source).
...
<SiteImage src="img/getting_started/osc_control_example.webp" alt="SuperDex Physics debugger showing the FR3 arm from the OSC control example" />
