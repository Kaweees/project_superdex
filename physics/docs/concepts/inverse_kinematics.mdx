...
The solver then calls [`Scene::Step`](pathname:///generated/api/v1.0.0/cpp/classsuperdex_1_1Scene.html) with an infinite timestep, which reduces the equations of motion to the quasistatic equilibrium condition:
